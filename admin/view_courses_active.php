        ...
        <div class="col-sm-4">
            <div class="page-header float-left">
                <div class="page-title">
                    <h1><i class="menu-icon fa fa-table"></i> Courses / Active Courses</h1>
                </div>
            </div>
        </div>
        <div class="col-sm-8">
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <li class="active">Active Courses</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12"><!--- col-lg-12 Starts --->
                ...
                <div class="card"><!--- card Starts --->
                    ...
                    <div class="card-body"><!--- card-body Starts --->
                        ...
                        <a href="index?view_courses" class="mr-2">
                        ...
                        <a href="index?view_courses_active" class="make-black font-weight-bold mr-2">
                                ...
                                while ($row_proposals = $get_proposals->fetch()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php } else { ?>
                                                <a class="text-danger"
                                                   href="index?removetoprated_proposal=<?= $proposal_id; ?>"
