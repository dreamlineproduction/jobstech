                    ...
                    <form action="" method="post">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="days_before_withdraw" class="form-control"
                                        value="<?= $days_before_withdraw; ?>" min="1" placeholder="1 Minimum"
                                        required="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <!--- input-group Ends --->
                                <small class="form-text text-muted">Here you can set proposal and buyer request minimum
                                    price that user can set during proposal/buyer request creation.</small>
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="withdrawal_limit" class="form-control"
                                        value="<?= $withdrawal_limit; ?>" placeholder="" required="">
                                </div>
                                <!--- input-group Ends --->
                                <small class="form-text text-muted">
                                    The minimum available balance a user must have to be able to request a withdrawal.
                                    Entering 5 will be $5.00 limit.
                                </small>
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="featured_fee" class="form-control"
                                        value="<?= $featured_fee; ?>" required="">
                                </div>
                                <!--- input-group Ends --->
                                <small class="form-text text-muted">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <!--- input-group Starts --->
                                    <input type="number" name="featured_duration" class="form-control"
                                        value="<?= $featured_duration; ?>" min="1" placeholder="1 Minimum" required="">
                                    <span class="input-group-addon">
                                        <b>Days</b>
                                    </span>
                                </div>
                        ...
                        <div class="form-group row">
                            <!--- form-group row Starts --->
                            <label class="col-md-3 control-label"> Allow Featured Proposal Request While Creating a
                                Proposal : </label>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select name="featured_proposal_while_creating" class="form-control" required="">
                                        <option value="1"
                                            <?php if($featured_proposal_while_creating == 1){ echo "selected"; } ?>> Yes
                                        </option>
                                        <option value="0"
                                            <?php if($featured_proposal_while_creating == 0){ echo "selected"; } ?>> No
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="processing_fee" class="form-control"
                                        value="<?= $processing_fee; ?>" min="0" placeholder="Enter Processing Fee"
                                        required="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="submit" name="update_general_payment_settings"
                                    value="Update General Payment Settings" class="btn btn-success form-control">
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                    </form>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            ?>
                        ...
                        <div class="form-group row">
                            <!--- form-group row Starts --->
                            <label class="col-md-3 control-label"> Commission Percentage For <?= $level_title; ?> :
                            </label>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <!--- input-group Starts --->
                                    <input type="number" name="seller_settings[<?= $i; ?>][commission_percentage]"
                                        class="form-control" value="<?= $row->commission_percentage; ?>" required="">
                                    <span class="input-group-addon"><b>%</b></span>
                                </div>
                                <!--- input-group Ends --->
                                <small class="form-text text-muted">Percentage comission to take out from every
                                    order.</small>
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        <div class="form-group row">
                            <!--- form-group row Starts --->
                            <label class="col-md-3 control-label"> What day & time in a month do you want to do payouts
                                for <?= $level_title; ?> : </label>
                            <div class="col-md-3">
                                <div class="input-group">
                ...
                ?>
                            ...
                            <div class="col-md-3">
                                ...
                                <label for="payout_anyday" class="float-right">
                                    ...
                                    <input class="payout_anyday" type="checkbox"
                                        name="seller_settings[<?= $i; ?>][payout_anyday]" value="1"
                                        <?php if($row->payout_anyday == 1){ echo "checked";} ?>>
                                </label>
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 control-label"></label>
                            <div class="col-md-6">
                                <input type="submit" name="update_seller_payment_settings"
                                    value="Update Seller Payment Settings" class="btn btn-success form-control">
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                    </form>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="enable_payoneer" class="form-control" required="">
                                    <option value="1" <?php if($enable_payoneer == 1){echo "selected";} ?>> Yes
                                    </option>
                                ...
                                <small class="form-text text-muted">In order for this to work, you need to enable manual
                                    payouts in general settings</small>
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        <!--- form-group row Ends --->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="paypal_email" class="form-control"
                                    value="<?= $paypal_email; ?>">
                                <small class="form-text text-muted">Enter a PayPal business email address in order to
                                    receive payments and also to transfer funds to that PayPal account .</small>
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">
                                    Currency code used for PayPal payments. Complete list <a class="text-success"
                                        href="https://developer.paypal.com/docs/classic/api/currency_codes/"
                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="stripe_webhook_key" class="form-control"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">Currency code. View complete list <a
                                        class="text-success" href="https://stripe.com/docs/currencies" target="_blank">
                                        here </a> </small>
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="coinpayments_ipn_secret"
                                    value="<?= $coinpayments_ipn_secret; ?>" class="form-control" />
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="<?= "$site_url/crypto_ipn"; ?>" class="form-control"
                                    readonly="">
                                <small class="form-text text-muted">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 control-label"> </label>
                            <div class="col-md-6">
                                <input type="submit" name="update_coinpayments_settings"
                                    class="btn btn-success form-control" value="Update Coinpayments Settings">
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                    </form>
                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 control-label"> </label>
                            <div class="col-md-6">
                                <input type="submit" name="update_mercadopago_settings"
                                    class="btn btn-success form-control" value="Update Mercadopago Settings">
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                    </form>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">Allow users to pay and withdraw using
                                    Paystack</small>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 control-label"> </label>
                            <div class="col-md-6">
                                <input type="submit" name="update_paystack_settings"
                                    class="btn btn-success form-control" value="Update Paystack Settings">
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                    </form>
        ...
        <div class="col-lg-12">
                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="dusupay_api_key" class="form-control"
                                    value="<?= $dusupay_api_key; ?>">
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="dusupay_secret_key" class="form-control"
                                    value="<?= $dusupay_secret_key; ?>">
                            </div>
                        </div>
                        <!--- form-group row Ends --->
            ...
            <hr class="mt-2"> -->
                        ...
                        <div class="form-group row d-none">
                            ...
                            <div class="col-md-6">
                                <select name="dusupay_method" class="form-control" required="">
                                    ...
                                    <option value="CARD" <?= ($dusupay_method == "CARD")?"selected":""; ?>> Card
                                    </option>
                                    <option value="BANK" <?= ($dusupay_method == "BANK")?"selected":""; ?>> Bank
                                    </option>
                                    <option value="CRYPTO" <?= ($dusupay_method == "CRYPTO")?"selected":""; ?>> Crypto
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row d-none">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="dusupay_provider_id" class="form-control"
                                    value="<?= $dusupay_provider_id; ?>">
                                <small class="text-muted">
                                    Click Here To Get <a class="text-success" target="_blank"
                                        href="index?get_provider_id">Provider Id</a>
                                </small>
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="dusupay_payout_method" class="form-control" required="">
                                    <option value="MOBILE_MONEY"> Mobile Money </option>
                                    <option value="BANK" <?= ($dusupay_payout_method == "BANK")?"selected":""; ?>> Bank
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">
                                    Currency code used for Dusupay payments and payouts. Complete list <a
                                        class="text-success"
                                        href="https://developer.paypal.com/docs/classic/api/currency_codes/"
                                        target="_blank">here</a>
                                </small>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="<?= "$site_url/dusupay_ipn"; ?>" class="form-control"
                                    readonly="">
                                <small class="form-text text-muted">
