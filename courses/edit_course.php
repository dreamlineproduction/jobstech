...
$sel_course = $db->select('courses', ['id' => $course_id]);
if ($sel_course->rowCount() == 0) {
    echo "<script>window.open('../login','_self')</script>";
    exit();
}
$course = $sel_course->fetch();
if ($course->seller_id != $login_seller_id) {
    echo "<script>window.open('../login','_self')</script>";
    exit();
}

$_SESSION['course_details'] = [
    'general_details' => [
        'course_title' => $course->title,
        'short_descrption' => $course->short_description,
    ...
    'requirements' => [
        'requirement1' => $course->requirement_1,
        'requirement2' => $course->requirement_2,
        'requirement3' => $course->requirement_3,
        'requirement4' => $course->requirement_4,
        'requirement5' => $course->requirement_5,
    ],
    'outcomes' => [
        'Outcomes1' => $course->outcomes_1,
        'Outcomes2' => $course->outcomes_2,
        'Outcomes3' => $course->outcomes_3,
        'Outcomes4' => $course->outcomes_4,
        'Outcomes5' => $course->outcomes_5,
    ],
    'pricing' => [
        'price' => $course->price,
    ...
    'overview' => [
        'course_overview_provider' => $course->course_overview_provider,
  ...
  ";
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', 'input[type=file]:not(#v_file):not([name=video_file_lesson]):not([name=document_file_lesson])', function () {
            ...
            $(document).on('change', 'input[name="video_file_lesson"])', function () {
                var size = $(this)[0].files[0].size;
                var ext = $(this).val().split('.').pop().toLowerCase();
            ...
            $(document).on('change', 'input[name="document_file_lesson"])', function () {
                var size = $(this)[0].files[0].size;
                var ext = $(this).val().split('.').pop().toLowerCase();
