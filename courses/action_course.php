...
if (!empty($_POST['action']) && $_POST['action'] == 'show_add_lesson_popup') {
    ...
    if (!empty($_SESSION['course_details']['chapters'])) {
        ...
        $html .=  '<option value="">Please select a chapter first.</option>';
    }
...
//        echo json_encode($response);
        ...
        $course_overview_provider = strtolower($_SESSION['course_details']['overview']['course_overview_provider']);
        if ($course_overview_provider == 'youtube') {
            //
        } elseif ($course_overview_provider == 'vimeo') {
            //
        } else {
            $course_preview_image_url = $_SESSION['course_details']['overview']['video_url'];
        }
        ...
        $insert_array = [
            ...
            'course_url' => str_slug($_SESSION['course_details']['general_details']['course_title']),
            ...
            'course_overview_provider' => $course_overview_provider_code[$course_overview_provider],
