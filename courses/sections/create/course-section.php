                ...
                <div class="wizard">
                    <div class="wizard-inner">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#step1" class="disabled" data-toggle="tab" aria-controls="step1" role="tab"
                            ...
                            <li role="presentation" class="disabled">
                                <a href="#step2" class="disabled" data-toggle="tab" aria-controls="step2" role="tab"
                                   aria-expanded="false"><span class="round-tab">2</span> <i>Requirements</i></a>
                            </li>
                            <li role="presentation" class="disabled">
                                <a href="#step3" class="disabled" data-toggle="tab" aria-controls="step3"
                                   role="tab"><span class="round-tab">3</span> <i>Outcomes</i></a>
                            </li>
                            <li role="presentation" class="disabled">
                                <a href="#step4" class="disabled" data-toggle="tab" aria-controls="step4"
                                   role="tab"><span class="round-tab">4</span> <i>Pricing</i></a>
                            </li>
                            <li role="presentation" class="disabled">
                                <a href="#step5" class="disabled" data-toggle="tab" aria-controls="step5"
                                   role="tab"><span class="round-tab">5</span> <i>Media</i></a>
                            </li>
                            <li role="presentation" class="disabled">
                                <a href="#step6" class="disabled" data-toggle="tab" aria-controls="step6"
                                   role="tab"><span class="round-tab">6</span> <i>Curriculum</i></a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content" id="main_form">
                        <div class="tab-pane active" role="tabpanel" id="step1">
                            <form role="form" action="" class="login-box" name="create_course_form"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="course_title"
                                                   id="course_title" placeholder="Title"
                                                   value="<?php echo(!empty($_SESSION['course_details']['general_details']['course_title']) ? $_SESSION['course_details']['general_details']['course_title'] : ''); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Short description *</label>
                                            <textarea class="form-control" id="short_descrption" name="short_descrption"
                                                      rows="3"
                                                      placeholder="Short Description"><?php echo(!empty($_SESSION['course_details']['general_details']['short_descrption']) ? $_SESSION['course_details']['general_details']['short_descrption'] : ''); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="description" name="description"
                                                      rows="8"><?php echo(!empty($_SESSION['course_details']['general_details']['description']) ? $_SESSION['course_details']['general_details']['description'] : ''); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                ...
                                <ul class="list-inline pull-right">
                                    <li>
                                        <button type="submit" class="btn btn-success next-step" data-form-name="1"
                                                id="form-1">Continue
                                        </button>
                                    </li>
                                </ul>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step2">
                            <form role="form" action="" class="login-box" name="course_requirement"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="requirement1"
                                                   name="requirement1" placeholder="Provide requirements"
                                                   value="<?php echo(!empty($_SESSION['course_details']['requirements']['requirement1']) ? $_SESSION['course_details']['requirements']['requirement1'] : ''); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="Requirements">Requirements 2</label>
                                            <input type="text" class="form-control" id="requirement2"
                                                   name="requirement2" placeholder="Provide requirements"
                                                   value="<?php echo(!empty($_SESSION['course_details']['requirements']['requirement2']) ? $_SESSION['course_details']['requirements']['requirement2'] : ''); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="Requirements">Requirements 3</label>
                                            <input type="text" class="form-control" id="requirement3"
                                                   name="requirement3" placeholder="Provide requirements"
                                                   value="<?php echo(!empty($_SESSION['course_details']['requirements']['requirement3']) ? $_SESSION['course_details']['requirements']['requirement3'] : ''); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="Requirements">Requirements 4</label>
                                            <input type="text" class="form-control" id="requirement4"
                                                   name="requirement4" placeholder="Provide requirements"
                                                   value="<?php echo(!empty($_SESSION['course_details']['requirements']['requirement4']) ? $_SESSION['course_details']['requirements']['requirement4'] : ''); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="Requirements">Requirements 5</label>
                                            <input type="text" class="form-control" id="requirement5"
                                                   name="requirement5" placeholder="Provide requirements"
                                                   value="<?php echo(!empty($_SESSION['course_details']['requirements']['requirement5']) ? $_SESSION['course_details']['requirements']['requirement5'] : ''); ?>">
                                        </div>
                                    </div>
                                </div>
                                <ul class="list-inline pull-right">
                                    ...
                                    <li>
                                        <button type="submit" class="btn btn-success next-step">Continue</button>
                                    </li>
                                </ul>
                            </form>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="Outcomes1" name="Outcomes1"
                                                   placeholder="Provide Outcome"
                                                   value="<?php echo(!empty($_SESSION['course_details']['outcomes']['Outcomes1']) ? $_SESSION['course_details']['outcomes']['Outcomes1'] : ''); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="Outcomes2">Outcomes 2</label>
                                            <input type="text" class="form-control" id="Outcomes2" name="Outcomes2"
                                                   placeholder="Provide Outcome"
                                                   value="<?php echo(!empty($_SESSION['course_details']['outcomes']['Outcomes2']) ? $_SESSION['course_details']['outcomes']['Outcomes2'] : ''); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="Outcomes3">Outcomes 3</label>
                                            <input type="text" class="form-control" id="Outcomes3" name="Outcomes3"
                                                   placeholder="Provide Outcome"
                                                   value="<?php echo(!empty($_SESSION['course_details']['outcomes']['Outcomes3']) ? $_SESSION['course_details']['outcomes']['Outcomes3'] : ''); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="Outcomes4">Outcomes 4</label>
                                            <input type="text" class="form-control" id="Outcomes4" name="Outcomes4"
                                                   placeholder="Provide Outcome"
                                                   value="<?php echo(!empty($_SESSION['course_details']['outcomes']['Outcomes4']) ? $_SESSION['course_details']['outcomes']['Outcomes4'] : ''); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="Outcomes5">Outcomes 5</label>
                                            <input type="text" class="form-control" id="Outcomes5" name="Outcomes5"
                                                   placeholder="Provide Outcome"
                                                   value="<?php echo(!empty($_SESSION['course_details']['outcomes']['Outcomes5']) ? $_SESSION['course_details']['outcomes']['Outcomes5'] : ''); ?>">
                                        </div>
                                    </div>
                                </div>
                                <ul class="list-inline pull-right">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" name="price" id="price"
                                                   ...
                                                   value="<?php echo(!empty($_SESSION['course_details']['pricing']['price']) ? $_SESSION['course_details']['pricing']['price'] : ''); ?>">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" name="discounted_price"
                                                   id="discounted_price" placeholder="Enter discounted price"
                                                   value="<?php echo(!empty($_SESSION['course_details']['pricing']['discounted_price']) ? $_SESSION['course_details']['pricing']['discounted_price'] : ''); ?>">
                                        </div>
                                    </div>
                                </div>
                                <ul class="list-inline pull-right">
                            ...
                            <form role="form" action="" class="login-box" name="course_overview" id="course_overview">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group"
                                             id="video_url_block" <?php echo @($_SESSION['course_details']['overview']['course_overview_provider'] == 'direct_upload') ? 'style=display:none;' : ''; ?>>
                                            <label>Course preview video url</label>
                                            <input class="form-control" type="text" name="video_url" id="video_url"
                                                   placeholder="Enter video url"
                                                   value="<?php echo @$_SESSION['course_details']['overview']['video_url']; ?>">
                                            <div class="error" id="video_url_error"></div>
                                        </div>

                                        <div class="form-group"
                                             id="image_upload_block" <?php echo @($_SESSION['course_details']['overview']['course_overview_provider'] == 'direct_upload') ? 'style=display:block;' : 'style=display:none;'; ?>>
                                            ...
                                            <div id="image-thumbnail">
                                                <?php if (!empty($_SESSION['course_details']['overview']['image_id'])) { ?>
                                                    <div id="image_box">
                                                        ...
                                                        ?>
                                                        <img width="200"
                                                             src="<?php echo $site_url; ?>/temp_images/thumb/<?php echo $name; ?>"
                                                             class="img-thumbnail">
                                                        <input type="hidden" name="image_id" id="image_id" value="56">
                                                        <div class="clearfix"></div>
                                                        <button type="button" class="btn btn-danger"
                                                                style="margin-top:10px;"
                                                                onclick="confirmDeleteImage();">Delete
                                                        </button>
                                                        <div>&nbsp;</div>
                                                    </div>
                                                <?php } ?>
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-md-12 text-right">
                                    <a class="btn btn-outline-primary" href="#" role="button" data-toggle="modal"
                                       data-target="#add_section"> <i class="fa fa-plus" aria-hidden="true"></i> Add
                                        Chapter</a>
                                    <a class="btn btn-outline-primary" href="javascript:void(0);"
                                       onclick="show_lesson_modal();" role="button"> <i class="fa fa-plus"
                                ...
                                <div class="col-md-12 mt-4 mb-5" id="course-wrapper">
                                    ...
                                    <div id="chapter-<?php echo $key; ?>" class="card created-lessons mt-4">
                                        <div class="card-body">
                                            <h6 class="">Chapter <?php echo $i; ?>:
                                                <strong><?php echo $chapter['chapter'] ?></strong></h6>
                                            <div class="edit-chapter-title">
                                                <div class="dropdown chapter-dropdown">
                                                    <i class="fa fa-ellipsis-h" aria-hidden="true" type="button"
                                                       id="dropdownMenuButton" data-toggle="dropdown"
                                                       aria-haspopup="true" aria-expanded="false"></i>
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="javascript:void(0);"
                                                           onclick="edit_chapter('<?php echo $key; ?>')">Edit</a>
                                                        <a class="dropdown-item" data-id="0"
                                                           onclick="delete_chapter('<?php echo $key; ?>')"
                                            ...
                                            <div id="lesson-wrapper-<?php echo $key; ?>">
                                                <?php foreach ($chapter['lesson'] as $lesson_key => $lesson) { ?>
                                                    <div class="single-lesson-display mt-4">
                                                        <div class="row">
                                                            <div class="col-md-11">
                                                                <h6 class="d-inline"><span class="font-weight-light">Lesson <?php echo $x; ?> :</span> <?php echo $lesson['lesson_title'] ?>
                                                                </h6>
                                                            </div>
                                                            <div class="col-md-1">
                                                                <div class="dropdown chapter-dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                           ...
                                                                           onclick="show_edit_lesson_popup('<?= $key ?>','<?= $lesson_key ?>','Chapter <?php echo $i; ?>: <strong><?php echo $chapter['chapter'] ?>')">Edit</a>
                                                                        <a class="dropdown-item"
                                                                           onclick="delete_lesson('<?= $key ?>','<?= $lesson_key ?>')"
                                                                           href="javascript:void(0);">Delete</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="card created-lessons mt-4">
                                            <div class="card-body">
                                                ...
                                                <div class="single-lesson-display mt-4">
                                                    <div class="row">
                                                        <div class="col-md-11">
                                                            <h6 class="d-inline"><span class="font-weight-light">Lesson 1 :</span>
                                                                ACCA FA1 Recording Financial Transactions</h6>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <div class="dropdown chapter-dropdown">
                                                                <i class="fa fa-ellipsis-h" aria-hidden="true"
                                                ...
                                                <div class="single-lesson-display mt-4">
                                                    <div class="row">
                                                        <div class="col-md-11">
                                                            <h6 class="d-inline"><span class="font-weight-light">Lesson 2 :</span>
                                                                ACCA FA1 Recording Financial Transactions</h6>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <div class="dropdown chapter-dropdown">
                                                ...
                                                <div class="single-lesson-display mt-4">
                                                    <div class="row">
                                                        <div class="col-md-11">
                                                            <h6 class="d-inline"><span class="font-weight-light">Lesson 3 :</span>
                                                                ACCA FA1 Recording Financial Transactions</h6>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <div class="dropdown chapter-dropdown">
                                ...
                                <ul class="list-inline pull-right">
                                    ...
                                    <li>
                                        <button onclick="publish_course();" type="button"
                                                class="btn btn-success next-step">Finish
                                        </button>
                                    </li>
                                </ul>
                            </div>
    ...
    function publish_course() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var form_data = [{name: 'action', value: 'save_course_details'}, {name: 'step', value: 'six'}];
                ...
                $.ajax({
                    ...
                    data: form_data,
                    beforeSend: function () {
                        $("#main_form").LoadingOverlay("show");
                    },
                    success: function (data) {
                        Swal.fire('Saved!', '', 'success').then((result) => {
                            if (result.isConfirmed) {
                                window.location = "<?php echo $site_url?>/proposals/view_courses";
                            }
                        })
                    },
                    error: function () {
