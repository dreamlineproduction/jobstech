...
<form method="post" enctype="multipart/form-data" runat="server" autocomplete="off">
        ...
        <div class="col-md-9 phoneNo">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="seller_phone"
                    placeholder="<?= $lang['placeholder']['phone']; ?>" value="<?= @$phone_no[1]; ?>" />
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            ...
            <input type="text" name="seller_city" placeholder="<?= $lang['placeholder']['city']; ?>"
                value="<?= $login_seller_city; ?>" class="form-control" required="" />
        ...
        <div class="col-md-9">
          ...
          ?>
                <option value="<?= $language_id; ?>"
                    <?php if($language_id == $login_seller_language){ echo "selected"; } ?>> <?= $language_title; ?>
                </option>
                <?php } ?>
                <?php } ?>
            </select>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            ...
            <img src="<?= getImageUrl2("sellers","seller_image",$login_seller_image); ?>" width="80"
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            ...
            <img src="<?= getImageUrl2("sellers","seller_cover_image",$login_seller_cover_image); ?>" width="80"
                class="img-thumbnail img-circle" />
            <?php }else{ ?>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <textarea name="seller_headline" id="textarea-headline" rows="3" class="form-control"
                maxlength="150"><?= $login_seller_headline; ?></textarea>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <textarea name="seller_about" id="textarea-about" rows="5" class="form-control" maxlength="300"
                placeholder="<?= $lang['placeholder']['description']; ?>"><?= $login_seller_about; ?></textarea>
            <span class="float-right mt-1">
    ...
    <hr>
    <button type="submit" name="submit" class="btn btn-success <?= $floatRight ?>"
        style="<?=($lang_dir == "right" ? 'margin-left: 110px;':'')?>">
    ...
    $('.crop_image').click(function(event) {
        ...
        $image_crop.croppie('result', {
            ...
            $.ajax({
                ...
                data: {
                    image: response,
                    name: $('input[type=file][name=' + name + ']').val().replace(
                        /C:\\fakepath\\/i, '')
                },
