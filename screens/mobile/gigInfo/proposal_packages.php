<div class="card-header pt-0 pl-3 tabs-header">
	...
	?>
        <li class="nav-item">
            <a class="nav-link <?php if($package_name == "Standard"){ echo " active"; } ?>"
                href="#tab_<?= $package_id; ?>" style="font-size:19px; font-weight:350;" data-toggle="tab"
                formid="checkoutForm<?= $i; ?>">
