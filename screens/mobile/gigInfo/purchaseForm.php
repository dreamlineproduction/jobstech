...
<a href="#" data-toggle="modal" data-target="#login-modal" class="btn btn-order bg-dark mb-3">
...
<form method="post" action="../../checkout" id="checkoutForm">
    ...
    <?php }else{ ?>
    <button type="submit" name="add_cart" class="btn btn-order bg-dark mb-3">
        <i class="fa fa-shopping-cart"></i> &nbsp;<strong>Add to Cart</strong>
    </button>
    <?php } ?>
