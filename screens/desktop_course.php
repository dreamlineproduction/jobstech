        ...
        <div class="row mb-5">
            ...
            <span>754,354 students</span> 
                ...
                <div class="what-you-learn mt-5">
                   ...
                   <h6 class="mb-0 text-muted font-weight-bold">45 sections • 322 lectures • 44h 29m total length</h6>
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
          <div class="row">
              ...
              <p><i class="fa fa-file-o mr-4" aria-hidden="true"></i>ML vs. DL vs. AI - What’s the Difference?</p>
              <p><i class="fa fa-video-camera mr-4" aria-hidden="true"></i>Why Machine Learning is the Future</p>
              <p><i class="fa fa-file-o mr-4" aria-hidden="true"></i>GET ALL THE CODES AND DATASETS HERE!</p>
...
<hr>
                   ...
                   <p class="mb-2">This course is fun and exciting, but at the same time, we dive deep into Machine Learning. It is structured the following way:</p>
                   <ul>
                     <li>
