            ...
            while ($row_cart = $select_cart->fetch()) {
                ...
                <div class="cart-proposal"><!--- cart-proposal Starts --->
                    ...
                    <h6 class="clearfix">
                        ...
                        <input type="text" name="quantity" class="float-right form-control quantity" min="1"
                               data-proposal_id="<?= $proposal_id; ?>" value="<?= $proposal_qty; ?>">
                    </h6>
                    <hr>
    ...
    <div class="card">
        <div class="card-body cart-order-details">
            ...
            <?php } elseif ($coupon_usage == "no" & isset($_GET['coupon_applied'])) { ?>
                <p class="coupon-response mt-2 p-2 bg-success text-white">Your coupon code has been applied
                    successfully.</p>
            ...
            <?php } elseif ($coupon_usage == "not_apply") { ?>
                <p class="coupon-response mt-2 p-2 bg-success text-white"> Your coupon code does not apply to
                    proposal/service in your cart. </p>
            <?php } ?>
