        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="lead pull-right">
                    Available For Withdrawal: <span class="font-weight-bold text-success">
                        <?= showPrice($current_balance); ?> </span>
                </p>
            </div>
            <div class="col-md-12">
                ...
                <div class="alert alert-success mt-2 text-center h6">
                    ...
                    <?php printf($lang["availRevenue"],$s_currency.$current_balance,$payout_date->format("F d, Y H:i A")); ?>
                </div> <!-- Alert ends -->
                <?php }else if($seller_payouts > 0 And empty($payout_anyday)){ ?>
                <div class="alert alert-success mt-2 text-center h6">
                    <!-- Alert starts -->
                    <i class="fa fa-exclamation-circle"></i>
                    You will be able to withdraw or send next payout request of (<?= $s_currency.$current_balance; ?>)
                    on the
                    <?php
					...
					?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?= $text; ?> Pending Clearance (<a href="order_details?order_id=<?= $order_id; ?>"
                                        target="blank" class="text-success"> View Order </a>)
                                    <?php }else{ ?>
                                    <?= $text; ?> (<a href="order_details?order_id=<?= $order_id; ?>" target="blank"
                                        class="text-success"> View Order </a>)
                                    <?php } ?>
                                </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <center>
                        ...
                        <p class="lead">
                            In order to transfer funds to your PayPal account, you will need to add your PayPal email in
                            your
                            <a href="<?= $site_url; ?>/settings?account_settings" class="text-success">account
                                settings</a> tab.
                        </p>
                        <?php }else{ ?>
                        <p class="lead">
                        ...
                        <form action="<?= ($wish_do_manual_payouts == 1)?"withdraw_manual":"paypal_adaptive"; ?>"
                            method="post">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="amount" class="form-control input-lg"
                                            min="<?= $withdrawal_limit; ?>" max="<?= $current_balance; ?>"
                                            placeholder="<?= $withdrawal_limit; ?> Minimum" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-8 offset-md-3">
                                    <input type="submit" name="withdraw" value="Transfer"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <center>
                        ...
                        <p class="lead">
                            In order to transfer funds to your Payoneer account, you will need to add your payoneer
                            email in your
                            <a href="<?= $site_url; ?>/settings?account_settings" class="text-success">account
                                settings</a> tab.
                        </p>
                        <?php }else{ ?>
                        <p class="lead">
                            Your revenue funds will be transferred to : <br>
                            <strong><?= $login_seller_payoneer_email; ?></strong>
                        </p>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="lead">
                        For Withdraw Payments To Your Mobile Money Account Please Add Your Mobile Money Account Details
                        In <a href="#" class="text-success" id="settings-link">Account Settings Tab</a>
                    </p>
                    <?php }else{ ?>
                    <p class="modal-lead">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <center>
                        ...
                        <p class="lead">
                            In order to transfer funds to your bitcoin wallet, you will need to add your wallet address
                            in your
                        ...
                        <form action="<?= ($wish_do_manual_payouts == 1)?"withdraw_manual":"withdraw_wallet"; ?>"
                            method="post">
