<script src="https://cdn.tiny.cloud/1/ouutnajyw0yyfzhie2ln4vsalvch8tdj3fgfquelznqr2yqv/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
<style>
.popover label {
    display: block;
    width: 100%;
...
<script src='https://cdn.tiny.cloud/1/ouutnajyw0yyfzhie2ln4vsalvch8tdj3fgfquelznqr2yqv/tinymce/5/tinymce.min.js' referrerpolicy="origin">
  </script>
  <script>
    tinymce.init({
      selector: '#mytextarea'
