                ...
                <ul class="nav nav-tabs flex-column flex-sm-row mt-4">
                    ...
                    <li class="nav-item">
                        <a href="#active-proposals" data-toggle="tab" class="nav-link make-black <?= $active; ?>">
                            <?= $lang['tabs']['active_proposals']; ?> <span
                                class="badge badge-success"><?= $count_active_proposals; ?></span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="#pause-proposals" data-toggle="tab"
                            class="nav-link make-black <?= (isset($_GET['paused']))?"active":""; ?>">
                            <?= $lang['tabs']['pause_proposals']; ?> <span
                                class="badge badge-success"><?= $count_pause_proposals; ?></span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="#pending-proposals" data-toggle="tab"
                            class="nav-link make-black <?= (isset($_GET['pending']))?"active":""; ?>">
                            <?= $lang['tabs']['pending_proposals']; ?> <span
                                class="badge badge-success"><?= $count_pending_proposals; ?></span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="#modification-proposals" data-toggle="tab"
                            class="nav-link make-black <?= (isset($_GET['modification']))?"active":""; ?>">
                            <?= $lang['tabs']['requires_modification']; ?> <span
                                class="badge badge-success"><?= $count_modification_proposals; ?></span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="#draft-proposals" data-toggle="tab"
                            class="nav-link make-black <?= (isset($_GET['draft']))?"active":""; ?>">
                            <?= $lang['tabs']['draft']; ?> <span
                                class="badge badge-success"><?= $count_draft_proposals; ?></span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="#declined-proposals" data-toggle="tab"
                            class="nav-link make-black <?= (isset($_GET['declined']))?"active":""; ?>">
                            <?= $lang['tabs']['declined']; ?> <span
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="<?= $login_seller_user_name; ?>/<?= $proposal_url; ?>"
                                                        class="dropdown-item"> Preview </a>
                                                    <?php if($proposal_featured == "no"){ ?>
                                                    <a href="#" class="dropdown-item"
                                                        id="featured-button-<?= $proposal_id; ?>">Make Proposal
                                                        Featured</a>
                                                    <?php }else{ ?>
                                                    <a href="#" class="dropdown-item text-success">Already Featured </a>
                                                    <?php } ?>
                                                    <a href="pause_proposal?proposal_id=<?= $proposal_id; ?>"
                                                        class="dropdown-item"> Deactivate Proposal</a>
                                                    <a href="view_coupons?proposal_id=<?= $proposal_id; ?>"
                                                        class="dropdown-item"> View Coupons</a>
                                                    <a href="view_referrals?proposal_id=<?= $proposal_id; ?>"
                                                        class="dropdown-item"> View Referrals</a>
                                                    <a href="edit_proposal?proposal_id=<?= $proposal_id; ?>"
...
EOT;
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="<?= $login_seller_user_name; ?>/<?= $proposal_url; ?>"
                                                        class="dropdown-item"> Preview </a>
                                                    <a href="activate_proposal?proposal_id=<?= $proposal_id; ?>"
                    ...
                    <div id="pending-proposals"
                        class="tab-pane fade show <?= (isset($_GET['pending']))?"active":""; ?>">
                        <div class="table-responsive box-table mt-4">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                    ...
                    <div id="modification-proposals"
                        class="tab-pane fade show <?= (isset($_GET['modification']))?"active":""; ?>">
                        <div class="table-responsive box-table mt-4">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                <button class="btn btn-success dropdown-toggle"
                                                    data-toggle="dropdown"></button>
                                                <div class="dropdown-menu">
                                                    <a href="submit_approval?proposal_id=<?= $proposal_id; ?>"
                                                        class="dropdown-item"> Submit For Approval </a>
                                                    <a href="<?= $login_seller_user_name; ?>/<?= $proposal_url; ?>"
                                                        class="dropdown-item"> Preview </a>
                                                    <a href="edit_proposal?proposal_id=<?= $proposal_id; ?>"
                                                        class="dropdown-item"> Edit </a>
                    ...
                    <div id="declined-proposals"
                        class="tab-pane fade show <?= (isset($_GET['declined']))?"active":""; ?>">
                        <div class="table-responsive box-table mt-4">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
