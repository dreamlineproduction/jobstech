        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                ...
                <div class="tab-content card card-body">
                    <!--- tab-content Starts --->
                    <div class="tab-pane fade <?php if(!isset($_GET['video']) AND !isset($_GET['instant_delivery']) and !isset($_GET['publish'])){ echo " show active"; } ?>"
                        id="overview">
                    ...
                    <?php } ?>
                    <div class="tab-pane fade <?php if(isset($_GET['instant_delivery'])){ echo "show active"; } ?>"
                        id="instant-delivery">
                    ...
                    <input type="hidden" name="section"
                        value="<?= (isset($_GET['instant_delivery']) ? "instant_delivery" : "overview"); ?>">
                </div>
                <!--- tab-content Ends --->
            </div>
            <!--- col-md-8 Ends --->
...
?>
    ...
    $(document).ready(function() {
        ...
        $('a[data-toggle="tab"]').on('shown.bs.tab', function(e) {
            var e = "" + e.target + "";
            var e = e.replace(
                '<?= $site_url; ?>/proposals/edit_proposal?proposal_id=<?= $proposal_id; ?>#', '');
            var e = e.replace(
                '<?= $site_url; ?>/proposals/edit_proposal?proposal_id=<?= $proposal_id; ?>&video#',
                '');
            var e = e.replace(
                '<?= $site_url; ?>/proposals/edit_proposal?proposal_id=<?= $proposal_id; ?>&instant_delivery#',
                '');
        ...
        $(document).on("click", ".pricing", function(event) {
            ...
            if (this.checked) {
                ...
                $('.add-attribute').hide();
                $('.proposal-price').show();
                $('.proposal-price input[name="proposal_price"]').attr('min',
                    <?= $min_proposal_price; ?>);
                ...
                $('.packages input[name="proposal_packages[1][price]"]').attr('min',
                    <?= $min_proposal_price; ?>);
                $('.packages input[name="proposal_packages[2][price]"]').attr('min',
                    <?= $min_proposal_price; ?>);
                $('.packages input[name="proposal_packages[3][price]"]').attr('min',
                    <?= $min_proposal_price; ?>);
