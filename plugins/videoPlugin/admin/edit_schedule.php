...
if(isset($_GET['edit_schedule'])){
  $edit_id = $input->get('edit_schedule');
  $get_schedule = $db->select("video_schedules",array("id"=>$edit_id));
  ...
  <div class="col-sm-4">
    <div class="page-header float-left">
      <div class="page-title">
        <h1><i class="menu-icon fa fa-clock-o"></i> Edit Video Schedule</h1>
      </div>
    </div>
  </div>
  <div class="col-sm-8">
    <div class="page-header float-right">
      <div class="page-title">
        <ol class="breadcrumb text-right">
          <li class="active">Edit Video Schedule</li>
        </ol>
      </div>
    </div>
  </div>
  ...
  <?php } ?>
    <div class="card"><!--- card Starts --->
      <div class="card-header"><!--- card-header Starts --->
        <h4 class="h4">Edit Video Schedule</h4>
      ...
      <div class="card-body"><!--- card-body Starts --->
        <form action="" method="post" enctype="multipart/form-data"><!--- form Starts --->
          ...
          <div class="form-group row"><!--- form-group row Starts --->
            ...
            <div class="col-md-6">
              <input type="submit" value="Update Schedule" class="btn btn-success form-control">
            </div>
          </div><!--- form-group row Ends --->
        </form><!--- form Ends --->
      </div><!--- card-body Ends --->
...
if(isset($_POST['title']) and isset($_POST['duration'])){
  ...
  if($val->run() == false){
    ...
    $data = $input->post();
    $insert_schedule = $db->update("video_schedules",$data,array("id"=>$edit_id));
    if($insert_schedule){
      successRedirect("Video Schedule Updated successfully.","index?view_schedules");
    }
  }
}
?>
