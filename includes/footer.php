        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-12">
                        <h3 class="h3Border" data-toggle="collapse" data-target="#collapseabout"><?= $lang['about']; ?>
                        </h3>
						...
						$link_url = $row_footer_links->link_url;
						?>
                            <li class="list-unstyled-item"><a href="<?= $link_url; ?>"><i
                    ...
                    <div class="col-md-4 col-12">
                        <h3 class="h3Border" data-toggle="collapse" data-target="#collapsecategories2">
                            <?= $lang['pages']; ?></h3>
                        <ul class="collapse show list-unstyled" id="collapsecategories2">
							...
							?>
                            <li class="list-unstyled-item"><a href="<?= "$site_url/pages/$url"; ?>"><?= $title; ?></a>
                            </li>
                            <?php } ?>
                        </ul>
                    </div>
            ...
            <div class="col-md-4 col-12">
                <!--- col-md-4 Starts --->
                <h3 class="h3Border" data-toggle="collapse" data-target="#collapsefindusOn"><?= $lang['find_us_on']; ?>
                </h3>
                <div class="collapse show" id="collapsefindusOn">
					...
					$link_url = $row_footer_links->link_url;
					?>
                        <li class="list-inline-item"><a href="<?= $link_url; ?>"><i
                                    class="fa <?= $icon_class; ?>"></i></a></li>
                        <?php } ?>
                    </ul>
