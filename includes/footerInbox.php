...
<img src="<?= $site_url; ?>/images/cookie.svg" class="img-fluid" alt="">
    ...
    <div class="col-md-12">
        ...
        <p class="mb-1">We use cookies to ensure you get the best experience. By using our website you agree <br>to our
            <a href='<?= $site_url; ?>/terms_and_conditions'>Privacy Policy</a>.</p>
