          ...
          ?>
                ...
                <form action="" method="post" class="pb-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name"
                            placeholder="<?= $lang['placeholder']['full_name']; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="u_name" placeholder="Enter Your Username"
                            value="<?php if(isset($_SESSION['u_name'])) echo $_SESSION['u_name']; ?>" required="">
            ...
            ?>
                    ...
                    <div class="form-group">
                        ...
                        <label class="form-control-label font-weight-bold"> <?= $lang['label']['country']; ?> </label>
      ...
      ?>
                    ...
                    <div class="form-group phoneNo">
                        ...
                        <div class="input-group">
                            ...
                            <span
                                class="input-group-addon p-0 border-0 rounded-0 w-50"><?php include("country_codes.php"); ?></span>

                            <input type="text" class="form-control w-750" name="phone"
                                placeholder="<?= $lang['placeholder']['phone']; ?>"
                                value="<?php if(isset($_SESSION['phone'])) echo $_SESSION['phone']; ?>"
                                <?= ($make_phone_number_required == 1)?"required":""; ?> />
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="pass"
                            placeholder="<?= $lang['placeholder']['password']; ?>" required="">
                    </div>

                    <div class="form-group">
                        <label class="form-control-label font-weight-bold"> <?= $lang['label']['password_confirm']; ?>
                        </label>
                        <input type="password" class="form-control" name="con_pass"
                            placeholder="<?= $lang['placeholder']['password_confirm']; ?>" required="">
                    ...
                    <div class="form-group">
                        ...
                        <label for="check">
                            I Accept
                            <a class="text-success" href="<?= $site_url; ?>/terms_and_conditions">Terms And
                                Conditions</a>
                        </label>
                    </div>
                ...
                <div class="text-center">
                    ...
                    <a href="#" onclick="window.location = '<?= $gLoginURL ?>';"
                        class="btn btn-danger btn-gplus-connect ">
                ...
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="seller_user_name"
                            placeholder="<?= $lang['placeholder']['username_or_email']; ?>"
                            value="<?php if(isset($_SESSION['seller_user_name'])) echo $_SESSION['seller_user_name']; ?>"
                            required="">
                    </div>
                    <div class="form-group">
                ...
                <form action="" method="post">
                    <div class="form-group">
                        <input type="text" name="forgot_email" class="form-control"
                            placeholder="<?= $lang['placeholder']['email']; ?>" required>
                    </div>
