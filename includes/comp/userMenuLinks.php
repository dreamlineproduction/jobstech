<div class="dropdown user-menu">
    <a href="#" id="usermenu" class="user dropdown-toggle menuItem" style="margin-top: 17px;" class="dropdown-toggle"
    ...
    <div class="dropdown-menu <?=($lang_dir=="right"?'text-right':'')?>"
        style="min-width:200px; width:auto!important;z-index:2000;">
        ...
        <div id="selling" class="dropdown-submenu collapse">
            ...
            <a class="dropdown-item" href="<?= $site_url; ?>/proposals/view_courses">
                My Courses
            </a>
            <?php if($count_active_proposals > 0){ ?>
