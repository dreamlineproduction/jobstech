...
<div class="row justify-content-center">
    <div class="online-seller mr-2 mb-2 mb-2 <?=($lang_dir == "right" ? 'text-right':'')?>">
        <a class="btn " href="#" role="button"><label>
    ...
    <div class="instant-delivery  mr-2 mb-2  <?=($lang_dir == "right" ? 'text-right':'')?>">
        <a class="btn" href="#" role="button"><label>
    ...
    <div class="category-by-filter mr-2 mb-2  <?=($lang_dir == "right" ? 'text-right':'')?>">
...
<!-- <div class="card border-gray mb-3">
    <div class="card-header bg-white">
        <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?> text-dark h5">
            <?= $lang['sidebar']['sort_by']['title']; ?></h3>
    </div>
    <div class="card-body">
...
<!-- <div class="card border-gray mb-3">
    <div class="card-header bg-white">
        <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?> text-dark h5">
            <?= $lang["sidebar"]["seller_country"]; ?></h3>
        <button
            class="btn btn-secondary btn-sm <?=($lang_dir == "right" ? 'float-left':'float-right')?> clear_seller_country clearlink"
...
<!-- <div class="card border-gray mb-3 seller-cities d-none">
    <div class="card-header bg-white">
        <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?> text-dark h5">
            <?= $lang["sidebar"]["seller_city"]; ?></h3>
        <button
            class="btn btn-secondary btn-sm <?=($lang_dir == "right" ? 'float-left':'float-right')?> clear_seller_city clearlink"
            onclick="clearCity()">
            <?= $lang['sidebar']['clear_filter']; ?>
        </button>
    </div>
...
<!-- <div class="card border-gray mb-3">
    <div class="card-header bg-white">
        <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?> text-dark h5">
            <?= $lang['sidebar']['categories']; ?></h3>
        <button
            class="btn btn-secondary btn-sm <?=($lang_dir == "right" ? 'float-left':'float-right')?> clear_cat_id clearlink"
            onclick="clearCat()">
            <?= $lang['sidebar']['clear_filter']; ?>
        </button>
    </div>
...
<!-- <div class="card border-gray mb-3">
    <div class="card-header bg-white">
        <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?> text-dark h5">
            <?= $lang['sidebar']['delivery_time']; ?></h3>
        <button
            class="btn btn-secondary btn-sm <?=($lang_dir == "right" ? 'float-left':'float-right')?> clear_delivery_time clearlink"
...
<!-- <div class="card border-gray mb-3">
    <div class="card-header bg-white">
        <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?> text-dark h5">
            <?= $lang['sidebar']['seller_level']; ?></h3>
        <button
            class="btn btn-secondary btn-sm <?=($lang_dir == "right" ? 'float-left':'float-right')?> clear_seller_level clearlink"
            onclick="clearLevel()">
            <?= $lang['sidebar']['clear_filter']; ?>
        </button>
    </div>
...
<!-- <div class="card border-gray mb-3">
    <div class="card-header bg-white">
        <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?> text-dark h5">
            <?= $lang['sidebar']['seller_lang']; ?></h3>
        <button
            class="btn btn-secondary btn-sm <?=($lang_dir == "right" ? 'float-left':'float-right')?> clear_seller_language clearlink"
