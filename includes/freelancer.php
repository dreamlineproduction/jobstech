            ...
            <div class="row">
                <div class="col-lg-9 col-md-12">
                    ...
                    <ul class="tagline mb-2 p-0">
                        ...
                        <li>
                            <a href="conversations/message.php?seller_id=<?= $seller_id; ?>"><i
                                    class="fa fa-comments-o"></i> <strong>Contact:</strong> <?= $seller_user_name; ?>
                            </a>
                        </li>
                        <li>
                            <small class="text-muted mt-1">
                    ...
                    <a id="chatBtn" data-toggle="tooltip" data-placement="top" title="Chat With Me"
                        href="conversations/message.php?seller_id=<?= $seller_id; ?>"
                        class="btn btn-success mt-2 mb-3 text-white"><i class="fa fa-comments-o" aria-hidden="true"></i>
                        Chat</a>
                </div>
				...
				?>
                        <h4 class="mb-1"><?php printf("%.1f", $average); ?>/<small
                                class="text-muted font-weight-normal">5</small></h4>
